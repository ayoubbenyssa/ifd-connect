...
class SliderBanner2Prof extends StatefulWidget {
  SliderBanner2Prof(this.user, this.chef_dept, {Key key}) : super(key: key);
  User user;
  var chef_dept;
...
class _SliderBannerState extends State<SliderBanner2Prof> {
  int _currentIndex = 0;
      ...
      Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) => BatchesPage(widget.user.user_id,
                  widget.user.employee_id, widget.user.token_user,widget.chef_dept)));
    }, "Notes"),
              ...
              decoration: BoxDecoration(
                image: new DecorationImage(
                    ...
                    colorFilter: new ColorFilter.mode(
                        Color(0xff95DCFF).withOpacity(0.34), BlendMode.dstATop),
