...
class _AddAbsenceState extends State<AddAbsence> {
  ...
  row(a,b)=>  Column(
    children: [
      ...
      SizedBox(height: 10.h,),
      a !='période' ?  Divider(color: Fonts.col_app_grey,thickness: 0.5,height: 0.5,) : Container(),
          ...
          decoration: BoxDecoration(
            ...
            child: Column(
              children: [
                ...
                row("séance", params["params"]["seance"].toString()),
                row("matiéres", params["nom_matieres"].toString()),

                row("Type d'absence", params["params"]["type_abs"].toString() == "1" ? "Absence" : "Retard"),


                row("période", params["params"]["periode"]['forenoon'] == true ? "matinee" +  ( (  params["params"]["periode"]['afternoon'] ) ? " et  apres-midi " : " ")
                :
