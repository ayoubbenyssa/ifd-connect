...
class TimeTableEmployee extends StatefulWidget {
  ...
  TimeTableEmployee(this._userId, this._studentId, this._token);

  @override
  _TimeTableEmployeeState createState() => _TimeTableEmployeeState();
}

class _TimeTableEmployeeState extends State<TimeTableEmployee>
...
//http://umpo.ml
    ...
    final timeTablesData = await http.post(
      "${prefs.getString('api_url')}/timetables_employee",
      body: param,
    );
    setState(() {
  ...
  Future<http.Response> getTimeTablesDetails(
    ...
    final timeTablesDetailsData = await http.post(
      "${prefs.getString('api_url')}/timetable_employee_details",
      body: param,
    );
    setState(() {
