...
import 'package:ifdconnect/login/confirmation_password.dart';
...
class Code_verification extends StatefulWidget {
  ...
  @override
  _Code_verificationState createState() => _Code_verificationState();
}
...
*/
  ...
  Widget build(BuildContext context) {
    ...
    Widget code_verificaion =  TextFieldWidget(
      "code verification",
      _focusemail,
      _emailcontroller,
      TextInputType.number,
      val.validateid_codeVerification,
      suffixIcon: "",
    )/*new Container(
