...
class _ReleveRestaurationState extends State<ReleveRestauration> {
  ...
  Future<String> _fetchReleveFromSharedPreferences() async {
  ...
  Future<http.Response> getReleve(
    ...
    final resStorage = await _fetchReleveFromSharedPreferences();
    ...
    if (resStorage != null) {
      ...
      return await  getReleveFromAPi(
          user_id,  student_id,  token);
    }


  }

  Future<http.Response> getReleveFromAPi(
      int user_id, int student_id, int token) async {
...
//{received: null, id: 7, updated_at: 2019-06-17T10:16:01Z, student_id: 1500, returned: null, amount: 150.0, created_at: 2019-06-17T10:16:01Z, operation: Recharge}
    ...
    print("rrrrrrrrrrrrr");
    print(reserveOperations.keys); //4
    print("rrrrrrrrr");
...
// print("k2");
      ...
      if(reserveOperations[k1]["price"] != null) {
        ...
        // print((reserveOperations[k1]["price"]+200).toString());

      }
      //
// print("allData ");
// print(allData.length);  //5
// print("allData");
